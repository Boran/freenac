...
$sortlimit=100;
$sortby='sys.name';   
$searchby='sys.r_ip';   // Your IP address
$searchstring= validate_webinput($_SERVER['REMOTE_ADDR']) ;
$title="End-device lastseen with IP address <$searchstring>";
$order_dir='DESC';
$order_op='=';   // exact match
#echo $searchstring;
