...
/**
 *
 * EditDevice_more.inc.php
 *
 * Long description for file:
 * Class to Display a generic Query, with sorting and active buttons
 *
 * @package     FreeNAC
 * @author      T.Dagonnier/FreeNAC Core Team
 * @copyright   2008 FreeNAC
 * @license     http://www.gnu.org/copyleft/gpl.html   GNU Public License Version 3
 * @version     SVN: $Id: Report1.php,v 1.1 2008/02/22 13:04:57 root Exp root $
...
// then print
        ...
        $out .= "<table id='t3-2' width='760' border='0' class='text13'>";
        $out .= '<tr><td>&nbsp;</td><td></td></tr>' ."\n";
        #$out .= '<tr><td width="87">Name:</td><td width="400">' ."\n";
