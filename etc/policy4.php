 ...
 * If such a global default vlan hasn't been defined, the connecting device will be denied.
...
class BasicPolicy extends Policy 
{
   ...
   */
   ...
   { 
      ...
      #Unknown devices and we have defined a global default vlan 
      ...
      #No global default vlan has been denied
      else
      {
