...
#
# TO DO: why are linefeeds disappearing from the email? Its all on one line, just an outlook effect?
#
# CHANGELOG:
...
messagecount=20;      # Nr. denies per interval called from cron. Tune per site.
macstoignore="000d.b914.d220|00188b870eb5|0015c53b82ce";    # Troublesome PCs to ignore when watching for DENYs
